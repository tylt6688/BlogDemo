    ...
    <div class="container" style="width:1200px;">
	   <div class="row">
	      <div class="col-md-12" style="background-color:rgb(250,250,250);margin-top:5px;padding:20px;">
			 ...
			 <form class="form-horizontal" action="/blog/TopicUpdateServlet" method="post">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-4">
			      <input class="form-control" onkeyup="value=value.replace(/[^1234567890-]+/g,'')" name="indexed" value="${topic.indexed }">
			    </div>
			  </div>
			  <div class="form-group">
