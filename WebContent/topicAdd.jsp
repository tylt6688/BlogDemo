  ...
  <body background="images/5.jpg">
    ...
    <div class="container" style="width:1200px;">
	    <div class="row" style="height:50px;background-color:rgb(250,250,250);margin-top:5px;">
		      ...
		      <button type="button" onclick="topicManage()" class="btn btn-info" style="float:right;margin:10px 0px;">主题管理</button>
    ...
    <div class="container" style="width:1200px;">
	   <div class="row">
	      <div class="col-md-12" style="background-color:rgb(250,250,250);margin-top:5px;padding:20px;">
			 ...
			 <form class="form-horizontal" action="/blog/TopicAddServlet" method="post">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-4">
			      <input class="form-control" onkeyup="value=value.replace(/[^1234567890-]+/g,'')" name="indexed">
			    </div>
			  </div>
			  <div class="form-group">
			    <div class="col-sm-offset-2 col-sm-10">
			      <div class="checkbox">
			        <label>
			          <input type="checkbox" name="deleted"> 是否禁用
			        </label>
			      </div>
			    </div>
			  </div>
