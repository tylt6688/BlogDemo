...
<body background="images/1.jpg">
	...
	<div class="container" style="width: 1200px;">
		<div class="row">
			<div class="col-md-12"
				style="background-color: rgb(250, 250, 250); margin-top: 5px; padding: 20px;">


				<form class="form-horizontal" action="/blog/BloggerAddServlet"
					method="post">
					<div class="form-group">
						<label class="col-sm-2 control-label">博文标题</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="bloggerTitle">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">博文标题</label>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea name="bloggerContent" cols="100" rows="8"
